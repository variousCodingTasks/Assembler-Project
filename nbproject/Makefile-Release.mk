...
${OBJECTDIR}/error_handler.o: error_handler.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/error_handler.o error_handler.c

${OBJECTDIR}/first_pass_processor.o: first_pass_processor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/first_pass_processor.o first_pass_processor.c

${OBJECTDIR}/hash_table.o: hash_table.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hash_table.o hash_table.c
...
${OBJECTDIR}/memory_manager.o: memory_manager.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/memory_manager.o memory_manager.c

${OBJECTDIR}/second_pass_processor.o: second_pass_processor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/second_pass_processor.o second_pass_processor.c

${OBJECTDIR}/symbol_table.o: symbol_table.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/symbol_table.o symbol_table.c

${OBJECTDIR}/word.o: word.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c89 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/word.o word.c
